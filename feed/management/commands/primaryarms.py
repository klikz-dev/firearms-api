...
class Command(BaseCommand):
    ...
    def getData(self):
        ...
        fileSize = os.stat(FILEDIR + "/files/PrimaryArms.csv").st_size
        if fileSize < 1000:
            sys.exit(1)
        ...
        for row in cr:
            ...
            if product.sale_price == 0 or product.image_url == "" or product.buy_link == "" or len(product.category) > 100 or len(product.brand_name) > 100:
                product.delete()
                continue
