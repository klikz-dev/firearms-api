...
from vendor.views import BrandSlugsSet, BrandViewSet, CategorySlugsSet, CategoryViewSet, PageSlugsSet, PageViewSet, ProductViewSet, SubcategorySlugsSet, SubcategoryViewSet
